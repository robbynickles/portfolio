...
Builder.load_file( 'the_game/drawing/drawingtoolkit.kv' )

from the_game.game_objects.collision_handlers import COLLTYPE_DEFAULT, COLLTYPE_BALL, COLLTYPE_USERPLAT, COLLTYPE_USERCURVE
...
class DrawingToolkit( GridLayout ):
        ...
        def magnetize( self ):
            return self.ids.magnet.state == 'down'
